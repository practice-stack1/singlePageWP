<?php
    get_header();//! код для отримання динамічної частини сторінки (хедер)
?>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?php the_field('our_team_img'); ?>" alt="наша команда">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                <h1 class="title"><?php the_field('history_main');?></h1>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                ...
                <div class="row">
                            ...
                            <div class="contacts__phones">
                                ...
                                <div class="contacts__phoneblock">
                                    ...
                                    <div class="contacts__phonewrap">
                                        ...
                                        <a href="tel:<?php the_field('phone_number_2', 2);?>"><?php the_field('phone_number_2', 2);?>8</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                            <?php echo do_shortcode('[contact-form-7 id="153" title="Формы отзывов"]');?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
