        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="154" title="Форма вопроса"]');?>
            </div>
        </div>
        <footer>
            <div class="container">
        ...
        <?php
            wp_footer();
        ?>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBCHJZmaKj7uBoioOZgD9d1s9cwm2b1cW8"></script> 
